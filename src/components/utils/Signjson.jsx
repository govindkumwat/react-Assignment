                    ...
                    <div className='row'>
                        ...
                        <div className='  col-lg-6 order-1 order-lg-2 header-img mt-5 fw-bold'>
                            <form>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputPassword1 navfont" class="form-label">Confirm Password</label>
                                    <input type="password" class="form-control" id="exampleInputPassword1" required/>
                                </div>
                              
                                <NavLink to={props.redirect} class="btn btn-primary navfont">Signup</NavLink>
                            </form>
                            <p className='mt-5 navfont'>Already A Member? <NavLink to="/">Login</NavLink></p>
                        </div>
                    </div>
                </div>
            </div>
